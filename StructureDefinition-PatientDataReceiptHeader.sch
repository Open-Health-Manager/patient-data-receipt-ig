...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MessageHeader">
      <sch:assert test="count(f:extension[@url = 'https://github.com/Open-Health-Manager/patient-data-receipt-ig/StructureDefinition/AccountExtension']) &gt;= 1">extension with URL = 'https://github.com/Open-Health-Manager/patient-data-receipt-ig/StructureDefinition/AccountExtension': minimum cardinality of 'extension' is 1</sch:assert>
